...
function loadTheme(theme) {
  ...
  if (theme === 'light') {
    themeBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" class="bkg--stroke" stroke-linecap="round" stroke-linejoin="round" class="feather feather-moon"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>`;
  } else {
...
themeBtn.addEventListener('click', () => {
  ...
  audio.currentTime = 0;
  audio.play();
  localStorage.setItem('portfolio.theme', `${theme}`), loadTheme(theme);
});
